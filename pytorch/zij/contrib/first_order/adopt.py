# Adapted from https://github.com/iShohei220/adopt (commit 6468572)
# Copyright (c) 2024 Shohei Taniguchi (iShohei220). Licensed under the Apache-2.0 license.
...
class ADOPT(Optimizer):
    r"""Implements ADOPT, a modified Adam that converges with any :math:`\beta_2`.
    ...
    :math:`\beta_2`. With :math:`v_0 = g_0^2` and :math:`m_0 = 0`, each step
    :math:`t \geq 1` computes:
    ...
    where the clipping bound defaults to :math:`c_t = t^{1/4}`, set through
    ...
    "ADOPT: Modified Adam Can Converge with Any :math:`\beta_2` with the Optimal
    Rate", NeurIPS 2024.
